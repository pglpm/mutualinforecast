...
%% Last-Updated: 2020-09-07T09:47:29+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
all other biological details. We imagine three cases, each of which could
be appropriate in a different context.

First: we consider all long-run response-frequency distributions, for each
stimulus, to be equally probable. This belief is represented by a Dirichlet
distribution with unit parameters. Our resulting guess about the long-run
mutual information is given by the probability distribution at the top of
\fig~\ref{fig:example_result}.
...
unity. Our resulting guess about the long-run mutual information is given
by the probability distribution in the middle of
\fig~\ref{fig:example_result}.

Third: we consider long-run response-frequency distributions of almost flat
shape to be more probable than peaked distributions. This belief is
represented by a Dirichlet distribution with parameters larger than unity.
