...
%% Last-Updated: 2020-08-09T14:14:16+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\ii}{\textrm{I}_{\textrm{h}}}
...
response frequencies, conditional to the two kinds of stimulus. If the two
kinds of stimulus are assumed to have equal sample frequencies and equal
long-run frequencies, then the mutual information between the stimulus and
response long-run frequencies is given by the specific formula
\begin{equation}
...
This is the probability density that the long-run mutual information has
...
\begin{equation}
  ...
  = 
  \exp\bigl( n\vsum \yfa\ln\yFa + n\vsum \yfb\ln\yFb \bigr)
